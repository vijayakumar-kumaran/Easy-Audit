    ...
    <div className="customer-view-page fade-in">
      <div className="view-page-header">
        <div className="header-meta">
          ...
          <h1>Select Client for Tax Assessment</h1>
          <p>Search and select an individual client profile from the directory to start a tax audit.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="no-records-card glass-card">
          ...
          <p>Ensure the client is registered first before creating a tax assessment.</p>
        </div>
      ) : (
