...
import { ArrowLeft, Save, AlertCircle, Calendar, UserCheck } from "lucide-react";
...
const CreateITNotice = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedDob = customer 
      ? formatDate(`${customer.month || ''}/${customer.day || ''}/${customer.year || ''}`)
      : '';
    ...
    try {
      await axios.post('/api/customer-it-notices', formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
      });
      setLoading(false);
      alert('IT Notice registered successfully');
  ...
  return (
    <div className="workflow-form-page fade-in">
      <div className="workflow-form-title">
        ...
        <h1>Register IT Notice Task</h1>
        <p>Log a newly received Income Tax notice for the client profile below.</p>
      </div>
          ...
          <div className="step-form-section">
            ...
            <div className="form-group-custom">
              ...
              <textarea 
                ...
                placeholder="Deadline notices, response templates, document requests..."
                required 
                className="form-control-custom"
