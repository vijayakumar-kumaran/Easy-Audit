    ...
    <div className="customer-view-page fade-in">
      <div className="view-page-header">
        <div className="header-meta">
          ...
          <h1>Select Business for IT Notice</h1>
          <p>Search and select a business client profile from the directory to assign a notice task.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="no-records-card glass-card">
          ...
          <p>Register the company first before creating an IT notice.</p>
        </div>
      ) : (
